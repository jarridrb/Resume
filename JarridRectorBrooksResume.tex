...
\item \underline{Research Project:} ``Investigating Sequential Model Optimization Techniques for Guided Drug Discovery''
\item \underline{Courses:} Probabilistic Graphical Models, Reinforcement Learning, Representation Learning, Theoretical Principles for Deep Learning
\item \underline{GPA:} 4.00
